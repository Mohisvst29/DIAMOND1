...
async function seed() {
  try {
    ...
    const settingsData = {
      hero: [
        {
          ...
          subtitle: "نحن في Diamond Growth نقدم حلولاً مبتكرة ومتكاملة في مجال المقاولات والإنشاءات لنبني مستقبلاً يليق بطموحاتكم.",
      ...
      home: {
        aboutSummary: "Diamond Growth هي شركة رائدة في مجال المقاولات، نجمع بين الخبرة العريقة وأحدث التقنيات لتقديم مشاريع تلبي وتتجاوز توقعات عملائنا.",
      },
      about: {
        content: "في Diamond Growth، نحن لا نبني مجرد مباني، بل نبني مستقبلاً مشرقاً وعلاقات طويلة الأمد مع عملائنا. منذ تأسيسنا، التزمنا بتقديم أعلى مستويات الجودة والاحترافية في جميع مشاريعنا، سواء كانت سكنية أو تجارية أو صناعية.",
      ...
      seo: {
        title: "Diamond Growth | للمقاولات",
        description: "شركة مقاولات رائدة متخصصة في البناء والتشييد بأعلى معايير الجودة",
        keywords: "مقاولات, بناء, تشييد, تصميم هندسي, Diamond Growth"
      },
      contact: {
        phones: ["+966505123456"],
