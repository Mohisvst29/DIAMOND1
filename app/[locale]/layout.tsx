...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `شركة مقاولات في الرياض - شركة مقاولات في السعودية - شركة إنشائية عامة`,
    description: `شركة مقاولات رائدة في السعودية تقدم خدمات المقاولات العامة، بناء الفلل، تركيب كاميرات مراقبة، أنظمة سمارت هوم، تحسين شبكة الجوال داخل المباني، وإنشاء بنية تحتية للاتصالات. اتصل بنا لتنفيذ مشاريعك بأعلى جودة.`,
    keywords: [
      "شركة مقاولات في السعودية",
      "شركة مقاولات في الرياض",
      "شركة مقاولات في المدينة المنورة",
      "مقاول بناء فلل في السعودية",
      "تنفيذ مشاريع مقاولات السعودية",
      "شركة إنشاءات عامة الرياض",
      "تركيب كاميرات مراقبة في الرياض",
      "شركة كاميرات مراقبة السعودية",
      "أنظمة سمارت هوم السعودية",
      "تركيب نظام إنذار حريق الرياض",
      "شركة أنظمة أمنية في السعودية",
      "تركيب access control الرياض",
      "تقوية شبكة الجوال داخل المباني",
      "IBS system في السعودية",
      "تحسين شبكة الاتصالات في الرياض",
      "شركات بنية تحتية اتصالات السعودية",
      "network optimization Saudi Arabia",
      "telecom contractors KSA",
      "أفضل شركة مقاولات في الرياض لتنفيذ المشاريع",
      "تكلفة تركيب كاميرات مراقبة في السعودية",
      "شركة تركيب أنظمة سمارت هوم في الرياض",
      "كيف تقوي شبكة الجوال داخل المباني",
      "شركات تنفيذ بنية تحتية للاتصالات في السعودية",
      "contracting company in Saudi Arabia",
      "construction company Riyadh",
      "CCTV installation Saudi Arabia",
      "smart home solutions KSA",
      "telecom infrastructure company Saudi Arabia"
    ],
    generator: "Next.js",
