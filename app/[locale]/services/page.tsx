...
export const metadata = {
  title: "خدماتنا - Diamond Growth",
  description:
    "شركة Diamond Growth تقدم خدمات المقاولات، الأعمال المدنية، الاتصالات، أنظمة التيار الخفيف، والخدمات الكهروميكانيكية بأعلى جودة في السعودية والأردن والمملكة.",
  keywords: [
    "مقاولات عامة",
    "الأعمال المدنية",
    "شبكات الاتصالات",
