...
const mockProjects = [
  ...
  },
  {
    ...
    date: "2023",
    location: "السعودية والأردن، المملكة العربية السعودية",
    content: "قمنا في النمو الماسي بتوريد وتركيب جميع أنظمة التيار الخفيف اللازمة لتشغيل البرج التجاري بكفاءة عالية. تضمن المشروع كاميرات مراقبة حديثة، أنظمة التحكم في الأبواب، وأحدث أنظمة إنذار وكشف الحريق."
  },
  {
    _id: "3",
...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  return {
    title: `${project.title} - النمو الماسي`,
