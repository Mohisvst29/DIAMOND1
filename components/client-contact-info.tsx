      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-white">
          <div className="text-center mb-12">
            ...
            <p className="text-lg opacity-90">تواصل معنا عبر أي من الطرق التالية وسيقوم فريقنا بالرد عليك في أقرب وقت</p>
          </div>
          ...
          <Card className="p-6 bg-white/10 border-white/20 text-white mb-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">عنوان المكتب الرئيسي</h3>
